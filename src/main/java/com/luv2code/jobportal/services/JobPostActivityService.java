...
public class JobPostActivityService {
    ...
    public List<RecruiterJobsDto> getRecruiterJobs(int recruiterId) {
        List<RecruiterJobs> recruiterJobsDtos= jobPostActivityRepository.getRecruiterJobs(recruiterId);
    ...
    public List<JobPostActivity> search(String job, String location, List<String> type, List<String> remote, LocalDate searchDate) {
        return Objects.isNull(searchDate)?jobPostActivityRepository.searchWithoutDate(
                job,
                location,
                remote,
                type
        ):jobPostActivityRepository.search(
                job,
                location,
                remote,
                type,
